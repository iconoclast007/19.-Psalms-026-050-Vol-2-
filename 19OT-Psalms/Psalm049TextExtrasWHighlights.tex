\chapter{Psalm 49}
\marginpar{\scriptsize \centering \fcolorbox{black}{lime}{\textbf{BIG PROBLEMS STILL REMAIN}}\\ (Psalm 49:1-20) \begin{compactenum}[I.][8]
...
\end{compactenum} }
[6] \textcolor[cmyk]{0.99998,1,0,0}{They that trust in \fcolorbox{blue}{bone}{their} wealth, and boast themselves in the multitude of \fcolorbox{blue}{bone}{their} riches;}\marginpar{\scriptsize \textcolor[rgb]{0.00,0.545,0.269}{$\rightarrow$``Their'' things: 
\begin{compactenum}
...
[8] \textcolor[cmyk]{0.99998,1,0,0}{(For the redemption of \fcolorbox{blue}{bone}{their} soul \emph{is} precious, and it ceaseth for ever:)}
[9] \textcolor[cmyk]{0.99998,1,0,0}{That he should still live for ever, \emph{and} not see corruption.}
[10] \textcolor[cmyk]{0.99998,1,0,0}{For he seeth \emph{that} wise men die, likewise the fool and the brutish person perish, and leave \fcolorbox{blue}{bone}{their} wealth to others.}
[11] \textcolor[cmyk]{0.99998,1,0,0}{Their inward thought \emph{is}, \emph{that} \fcolorbox{blue}{bone}{their} houses \emph{shall} \emph{continue} for ever, \emph{and} \fcolorbox{blue}{bone}{their} dwelling places to all generations; they call \emph{their} lands after \fcolorbox{blue}{bone}{their} own names.}
[12] \textcolor[cmyk]{0.99998,1,0,0}{Nevertheless man \emph{being} in honour abideth not: he is like the beasts \emph{that} perish.}
[13] \textcolor[cmyk]{0.99998,1,0,0}{This \fcolorbox{black}{lime}{\fcolorbox{blue}{bone}{their} way} \emph{is} \fcolorbox{blue}{bone}{their} folly: yet \fcolorbox{blue}{bone}{their} posterity approve \fcolorbox{blue}{bone}{their} sayings. Selah.}
[14] \textcolor[cmyk]{0.99998,1,0,0}{Like sheep they are laid in the grave; death shall feed on them; and the upright shall have dominion over them in the morning; and \fcolorbox{blue}{bone}{their} beauty shall consume in the grave from \fcolorbox{blue}{bone}{their} dwelling.}
