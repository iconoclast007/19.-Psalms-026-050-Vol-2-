...
\marginpar{\scriptsize \centering \fcolorbox{blue}{lime}{\textbf{TEMPORARY TRIUMPH}}\\ (Psalm 37:1-40) \begin{compactenum}[I.][14]
...
\\
\textcolor[cmyk]{0.99998,1,0,0}{Fret \underline{not} thyself because of \fcolorbox{blue}{lime}{evildoers}, neither be thou envious against the workers of iniquity.}
...
[11] \textcolor[cmyk]{0.99998,1,0,0}{But the meek shall inherit the earth; and shall delight themselves in the abundance of \fcolorbox{blue}{lime}{peace}.}\footnote{\textbf{Matthew 5;5} - Blessed are the meek: for they shall inherit the earth.}
[12] \textcolor[cmyk]{0.99998,1,0,0}{The wicked \fcolorbox{blue}{lime}{plotteth} against the just, and gnasheth upon him with his teeth.}
...
[20] \textcolor[cmyk]{0.99998,1,0,0}{But the wicked shall \fcolorbox{blue}{lime}{perish}, and the enemies of the LORD \emph{shall} \emph{be} as the fat of lambs: they shall consume; into smoke shall they consume away.}
...
[28] \textcolor[cmyk]{0.99998,1,0,0}{For the LORD loveth judgment, and forsaketh \underline{not} his saints; they are \fcolorbox{blue}{lime}{preserved} for ever: but the seed of the wicked shall be cut off.}
...
[35] \textcolor[cmyk]{0.99998,1,0,0}{I have seen the wicked in great \fcolorbox{blue}{lime}{power}, and spreading himself like a green bay tree.}\footnote{\textbf{Matthew 13:31-32} - Another parable put he forth unto them, saying, The kingdom of heaven is like to a grain of mustard seed, which a man took, and sowed in his field: [32 ]Which indeed is the least of all seeds: but when it is grown, it is the greatest among herbs, and becometh a tree, so that the birds of the air come and lodge in the branches thereof.}
[36] \textcolor[cmyk]{0.99998,1,0,0}{Yet \underline{he} \fcolorbox{blue}{lime}{passed} away, and, lo, \underline{he} \emph{was} \underline{not}: yea, I sought him, but \underline{he} could \underline{not} be found.}
